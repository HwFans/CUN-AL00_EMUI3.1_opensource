...
//add by zym,2015-07-23
typedef struct{
	unsigned char x[4];
	unsigned char y[4];
	unsigned char z[4];
	unsigned char reserve[4];
}alsps_calibrate_struct_bionic;  //avoid multi define in hqnvram library

#define ALSPS_GET_CALIBRATION_DATA			_IOR(ALSPS,0x21,alsps_calibrate_struct_bionic)
#define ALSPS_SET_CALIBRATION_DATA			_IOR(ALSPS,0x22,alsps_calibrate_struct_bionic)
//end by zym
