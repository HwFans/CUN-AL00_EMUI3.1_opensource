...
#if 1 //def HQ_META_PWRKEY_3S_PRESS_POWEROFF   //add by lupingzhong for 3s poweroff in meta mode
...
#if 1 //def HQ_META_PWRKEY_LONG_PRESS_POWEROFF                      //add by yinliangliang for 3s poweroff in meta mode
