...
u32 pinSet[3][8] = {
    ...
    if (On) {
        ...
        else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3L2_MIPI_RAW, currSensorName)))
        {
...
*/
        ...
        else  if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV5670_HQ_MIPI_RAW, currSensorName))))
        {
            //mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
            //mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
            //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
