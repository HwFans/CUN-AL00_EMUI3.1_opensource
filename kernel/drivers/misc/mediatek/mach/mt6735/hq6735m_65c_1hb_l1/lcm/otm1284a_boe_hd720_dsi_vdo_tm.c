...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	*/
	...
	//must use 0x39 for init setting for all register.
				...
				{0x00,1,{0x91}},
				{0xb0,1,{0x92}},   //disable timeout function by libin
                ...
                {0xf5,1,{0x85}},
                       ...
                       //-------------------- Gamma Tuning--------------------//
		//00,19,27,37,45,54,56,83,75,8F,72,5C,6E,4A,46,37,27,14,07,00 ;
                {0x00,1,{0x00}},
               {0xE1,20,{0x00,0x19,0x27,0x37,0x45,0x54,0x56,0x83,0x75,0x8F,0x72,0x5C,0x6E,0x4A,0x46,0x37,0x27,0x14,0x07,0x00}},
                //{0x00,0x19,0x27,0x36,0x45,0x53,0x55,0x82,0x74,0x8e,0x74,0x5d,0x6f,0x45,0x41,0x31,0x21,0x11,0x07,0x00}},

	 //{0xE1,20,{0x00,0x19,0x27,0x36,0x45,0x53,0x55,0x82,0x74,0x8e,0x74,0x5d,0x6f,0x45,0x41,0x31,0x21,0x11,0x07,0x00}},

		
		//00,19,27,37,45,54,56,83,75,8F,72,5C,6E,4A,46,37,27,14,07,00; 
                                                                                                           
                {0x00,1,{0x00}},
                {0xE2,20,{0x00,0x19,0x27,0x37,0x45,0x54,0x56,0x83,0x75,0x8F,0x72,0x5C,0x6E,0x4A,0x46,0x37,0x27,0x14,0x07,0x00}},
               //{0xE2,20,{0x00,0x19,0x27,0x36,0x45,0x53,0x55,0x82,0x74,0x8e,0x74,0x5d,0x6f,0x45,0x41,0x31,0x21,0x11,0x07,0x00}},
               ...
               // {0xd9,1,{0x01}},
                ...
                {0xce,14,{0x38,0x0b,0x85,0x00,0x8d,0x00,0x00,0x38,0x0a,0x85,0x01,0x8d,0x00,0x00}},
                
                {0x00,1,{0xb0}},                                                //panel CLKA3/4 setting
                {0xce,14,{0x38,0x09,0x85,0x02,0x8d,0x00,0x00,0x38,0x08,0x85,0x03,0x8d,0x00,0x00}},
                
                {0x00,1,{0xc0}},                                 //panel CLKb1/2 setting
                {0xce,14,{0x38,0x07,0x85,0x04,0x8d,0x00,0x00,0x38,0x06,0x85,0x05,0x8d,0x00,0x00}},
                
                {0x00,1,{0xd0}},                                                //panel CLKb3/4 setting
                {0xce,14,{0x38,0x05,0x85,0x06,0x8d,0x00,0x00,0x38,0x04,0x85,0x07,0x8d,0x00,0x00}},
              ...
              // {0x90,1,{0x1a}},
               ...
               {0x00,1,{0x00}},                                                                                                   
               {0xff,3,{0xff,0xff,0xff}}, //Orise mode disable 
...
static unsigned int lcm_compare_id(void)
{
	...
	printf("otm1284a_boe_lcm_compare_id lk -- lcm_adc = %d \n",lcm_adc);
	printf("%s %d\n", __func__,__LINE__);

	#ifdef BUILD_LK
	ret=TPS65132_write_byte(cmd,data_boe);
    if(ret)    	
    dprintf(0, "[LK]otm1284a_boe----tps6132----cmd=%0x--i2c write error----\n",cmd);    	
	else
	dprintf(0, "[LK]otm1284a_boe----tps6132----cmd=%0x--i2c write success----\n",cmd);    		
#else
	ret=tps65132_write_bytes(cmd,data_boe);
	if(ret<0)
	printk("[KERNEL]otm1284a_boe----tps6132---cmd=%0x-- i2c write error-----\n",cmd);
	else
	printk("[KERNEL]otm1284a_boe----tps6132---cmd=%0x-- i2c write success-----\n",cmd);
#endif
    ...
    #endif 
	 return ((LCM_ID_OTM1284A_BOE == id)&&(lcm_adc<100))?1:0;
...
LCM_DRIVER otm1284a_boe_hd720_dsi_vdo_tm_lcm_drv = 
{
    .name			= "otm1284a_boe_dsi",
