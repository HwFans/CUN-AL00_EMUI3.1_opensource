...
static struct i2c_board_info kd_lens_dev __initdata = { I2C_BOARD_INFO("DW9718AF", 0x19) };
...
/**************DW9718S Setting guide********************************/
    	char puSuspendCmd[2] = {0x01,0x39};
    	i4RetValue = i2c_master_send(g_pstDW9718AF_I2Cclient, puSuspendCmd, 2);
   		char puSuspendCmd1[2] = {0x05,0x04};//0x79
	   	i4RetValue = i2c_master_send(g_pstDW9718AF_I2Cclient, puSuspendCmd1, 2);
    return 0;
}
...
static int DW9718AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	g_pstDW9718AF_I2Cclient->addr = 0x18>>1;//g_pstDW9718AF_I2Cclient->addr >> 1;
