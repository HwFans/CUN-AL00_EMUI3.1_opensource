...
#define AF_DRVNAME "DW9714HI843BAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x20
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714hi843baf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714hi843baf"
...
inline static int getAFInfo(__user stDW9714HI843BAF_MotorInfo * pstMotorInfo)
{
    stDW9714HI843BAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9714HI843BAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9714HI843BAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9714HI843BAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9714HI843BAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9714HI843BAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9714HI843BAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9714HI843BAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9714HI843BAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW9714HI843BAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW9714HI843BAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9714HI843BAFIOC_T_SETMACROPOS :
...
static int __init DW9714HI843BAF_i2C_init(void)
{
    i2c_register_board_info(LENS_I2C_BUSNUM, &kd_lens_dev, 1);
	printk("baoyaunrui__DW9714HI843BAF_i2C_init!!!");
...
static void __exit DW9714HI843BAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9714HI843BAF_i2C_init);
module_exit(DW9714HI843BAF_i2C_exit);

MODULE_DESCRIPTION("DW9714HI843BAF lens module driver");
