...
#define AF_DRVNAME "DW9714IMX219AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9714imx219af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9714imx219af"

static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO(AF_DRVNAME, 0x24)};
...
inline static int getAFInfo(__user stDW9714IMX219AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9714IMX219AF_MotorMETAInfo * pstMotorMETAInfo)
{
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9714IMX219AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9714IMX219AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9714IMX219AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9714IMX219AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
