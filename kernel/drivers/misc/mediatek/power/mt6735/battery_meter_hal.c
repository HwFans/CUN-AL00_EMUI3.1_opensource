...
/*Bill add start 20150923, charging state: +0 mv ; discharging: adc + offset: 15mv  */
extern kal_bool gFG_Is_Charging;
/*Bill add end*/
static kal_int32 read_adc_v_bat_sense(void *data)
{
	kal_int32 offset = 5 ;  /* + 15mv */
#if defined(CONFIG_POWER_EXT)
    *(kal_int32*)(data) = 4201;
#else
#if defined(SWCHR_POWER_PATH)
...
#endif
	if (gFG_Is_Charging)
		*(kal_int32*)(data) = *(kal_int32*)(data);
	else
		*(kal_int32*)(data) = *(kal_int32*)(data)+ offset;
    return STATUS_OK;
}
