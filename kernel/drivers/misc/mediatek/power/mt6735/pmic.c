...
kal_uint32 upmu_get_rgs_chrdet_nolock(void)
{
	kal_uint32 val=0;

	//val = mt6325_upmu_get_rgs_chrdet();
	pmic_read_interface_nolock(MT6328_PMIC_RGS_CHRDET_ADDR, &val, MT6328_PMIC_RGS_CHRDET_MASK, MT6328_PMIC_RGS_CHRDET_SHIFT);
...
void pwrkey_int_handler(void)
{
	...
	{
//lupingzhong add for marking when powerkey is pressed.
		#ifdef CONFIG_HQ_BOOT_WITH_VIBRATOR
...
void pwrkey_int_handler_r(void)
{
	...
	{
//lupingzhong add for marking when powerkey is released.
	    	#ifdef CONFIG_HQ_BOOT_WITH_VIBRATOR
	 		pwrkey_pressed_flag = false;
     		#endif
...
void chrdet_int_handler(void)
{
	...
	if (upmu_get_rgs_chrdet()) {
 	//step 1
		vcorefs_request_dvfs_opp(KIR_USB, OPPI_PERF);
		//step 2
//		pmic_config_interface(0x494,0x0,0x3,0);
//		pmic_config_interface(0x496,0x0,0x3,0);
		//VCORE
		pmic_config_interface(0x620,0x0,0x3,0);
		pmic_config_interface(0x622,0x0,0x3,0);
		//VSYS
		pmic_config_interface(0x648,0x0,0x3,0x0);
		pmic_config_interface(0x64A,0x0,0x3,0x0);
	}
	else {
		//step 1
		vcorefs_request_dvfs_opp(KIR_USB, OPPI_UNREQ);
		//step 2
//		pmic_config_interface(0x494,0x3,0x3,0);
//		pmic_config_interface(0x496,0x3,0x3,0);
		//VCORE
		pmic_config_interface(0x620,0x3,0x3,0);
	    pmic_config_interface(0x622,0x3,0x3,0);
		//VSYS
		pmic_config_interface(0x648,0x3,0x3,0x0);
		pmic_config_interface(0x64A,0x3,0x3,0x0);
	}
...
void PMIC_CUSTOM_SETTING_V1(void)
{
	...
	//add by zym for enhance pmic powerdown speed
	pmic_config_interface(0x2b2,0x1,0x1,9);
	pmic_config_interface(0xA1C,0x1,0x1,10);
    #endif
}
