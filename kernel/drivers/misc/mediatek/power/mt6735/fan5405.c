...
{             
    ...
    //---------------------
  //  fan5405_hw_init();
   //fan5405_reg_config_interface(0x06,0x77);// ISAFE = 1450mA, VSAFE = 4.34V, add for al912
  //add for al912 debug, libin
  printk("[fan5405] First dump register begin: \n");
  fan5405_dump_register();
  printk("[fan5405] First dump register end: \n");
    fan5405_reg_config_interface(0x06,0x57); // ISAFE = 1450mA, VSAFE = 4.34V, add for al912
    fan5405_set_tmr_rst(0x1);                       //add for al912 , libin
    fan5405_set_te(0x1);
    fan5405_set_v_low(0);                            //REG1[5,4]=00,Vlowv=3.4v,add for al912, libin
    fan5405_reg_config_interface(0x05,0x04);
    printk("[fan5405] finish config,  dump register begin: \n");
    fan5405_dump_register();
    printk("[fan5405] finish config,  dump register end: \n");
