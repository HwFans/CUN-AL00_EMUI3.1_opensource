...
#endif
#if defined(OV8855_MIPI_RAW)
    {OV8855_SENSOR_ID, SENSOR_DRVNAME_OV8855_MIPI_RAW, OV8855_MIPI_RAW_SensorInit},
#endif
#if defined(SP2509_MIPI_RAW)
    {SP2509_SENSOR_ID, SENSOR_DRVNAME_SP2509_RAW,SP2509_MIPI_RAW_SensorInit},
#endif
