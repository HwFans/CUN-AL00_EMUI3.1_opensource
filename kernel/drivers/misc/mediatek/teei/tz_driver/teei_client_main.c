...
static struct teei_contexts_head {
	u32 dev_file_cnt; /**< context 数量 */
	struct list_head context_list; /**< context 链表 */
                ...
                struct semaphore *psema)
{
	...
	/* with a wmb() */
	wmb();
	smp_call_function_single(0, secondary_teei_smc_call, (void *)(&smc_call_entry), 1);
...
{
	smp_call_function_single(0, secondary_boot_stage2, NULL, 1);
}
...
{
	smp_call_function_single(0, secondary_load_tee, NULL, 1);
}
...
int send_fp_command(unsigned long share_memory_size)
{
	...
	/* with a wmb() */
	wmb();
	smp_call_function_single(0, secondary_send_fp_command, (void *)(&fp_command_entry), 1);
...
static void boot_stage1(unsigned long vir_address)
{
	...
	smp_call_function_single(0, secondary_boot_stage1, (void *)(&boot_stage1_entry), 1);
