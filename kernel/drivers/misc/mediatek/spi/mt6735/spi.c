...
//begin, [microtrust] [Jason.han] [remove] [temp delete the spi_gpio_pin ][2015.04.01]
#if 0// (!defined(CONFIG_NEU_TZ_DRIVER))
...
#endif
//end, [microtrust] [Jason.han] [remove] [temp delete the spi_gpio_pin ][2015.04.01]    
	/* lenovo-sw, chenzz3, change for fingerprint, end */
...
{
#if (!defined(CONFIG_MT_SPI_FPGA_ENABLE))
//begin, [microtrust] [Jason.han] [remove] [temp delete the disale_clk][2015.04.20]
#if (!defined(CONFIG_NEU_TZ_DRIVER))
	disable_clock(MT_CG_PERI_SPI0, "spi");
#endif
//end, [microtrust] [Jason.han] [remove] [temp delete the disale_clk][2015.04.20]
#endif
	return;
}
