...
struct tpd_device {
	...
	int gesture_enablee;  // 20140917
    int gesture_enablec; 
    int gesture_enablev;  
    int gesture_enablem;  // 20140917
    int gesture_enableo; 
    int gesture_enablew; 
    int gesture_enables;  // 20140917
    int gesture_enablez; 
    int gesture_enableaa;  
    int gesture_enablebb;  // 20140917
    int gesture_enableab; 
    int gesture_enableba; 
    int gesture_enablecc; 
	struct tasklet_struct tasklet;
	int btn_state;
    char *hq_ctp_module_name; //kaka_12_0110  // @liguangxian20150310 
